...
def main():
    ...
    st.sidebar.text('This project is made for demonstration\nprupose only,the data used is from\nkaggle.')
    
    if st.sidebar.button('github link'):
        st.sidebar.markdown('https://github.com/patrickn699/Loan_App.git', unsafe_allow_html = True)
